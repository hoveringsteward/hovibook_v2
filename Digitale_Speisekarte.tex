...
Die Speisekarte soll es dem Gast ermöglichen die Wartezeit auf einen Kellner, welcher normalerweise die Bestellung entgegen nimmt, zu ersparen. Sobald er das Lokal betritt soll er sich bereits zum Tisch setzen und seine Wunschspeisen auf dem Tablet auswählen können.
Die Bediensteten im Lokal sollen ebenfalls von der digitalen Speisekarte profitieren, da ihnen dadurch ein Teil ihrer Arbeit abgenommen werden soll.
Wie jede herkömmliche Speisekarte, soll auch die digitale Speisekarte dem Gast die genauen Speiseinformationen anzeigen.
Außerdem soll die digitale Speisekarte dem Hexacopter die Tischroute des Tisches, von welchem die Speise bestellt wurde, schicken, sobald sie bereit ist ausgeliefert zu werden. Dies soll dadurch bewerkstelligt werden, dass ein Administrator in einer Liste, in welcher ihm eine Übersicht von den bestellten Speisen geboten wird, neben der fertigen Speise auf einen "Ausliefern"-Button klickt.
...
Die digitale Speisekarte und das Java Programm kommunizieren nicht direkt sondern nur über die MySQL Datenbank miteinander. Das Java Programm, welches für die Datenübermittlung mit dem Hexacopter entwickelt wurde, wird im Kapitel 11 genauer erklärt.
			\begin{figure}[H]
			\begin{centering}
...
Wenn der Gast jedoch auf "Ja" klickt, öffnet sich eine Alertmeldung, die ihn darauf hinweist, dass die Bestellung betätigt wurde. Anschließend kann er sie unter dem Menüpunkt "Bestellungen" ansehen und dort ihren aktuellen Status verfolgen.\\
  \end{itemize}
...
Im Header befindet sich ein Button mit einem Ausloggen-Symbol, damit der Administrator sich jederzeit abmelden kann, als auch ein Button mit einem Einstellungssymbol abgebildet, welches auf den Einstellungsübersichts-Screen verlinkt.
...
\begin{table}[H]
\centering
\begin{tabular}{|p{1.5cm}|p{3cm}|p{4cm}|p{4cm}|p{1.5cm}|} 
\hline \textbf{ID} & \textbf{Bezeichnung} & \textbf{Testszenario} & \textbf{Erwartetes Ergebnis} & \textbf{Ergebnis erreicht?} \\\hline
\hline 1 & Adminlogin & Admin meldet sich mit richtigen Anmeldedaten an & Hauptscreen des Admininterfaces wird angezeigt & Ja \\\hline
\hline 2 & Speisebestellung & eine Speise wird bestellt & neuer Bestellungseintrag wird erstellt und in Bestellliste angezeigt & Ja \\\hline
\hline 3 & "Ausliefern"-Wert ändern & Admin klickt auf "Ausliefern"-Button & "ausliefern"-Wert der Speise wird auf 1 gesetzt & Ja \\\hline
\hline 4 & Tischroute schicken & Hexacopter schickt bestimmte Nachricht an Server & Server schickt Tischnummer zurück & Ja \\\hline
\hline 5 & Speiseeintrag hinzufügen & Admin gibt neue Speisedaten ins Formular ein und klickt auf "Speiseeintrag hinzufügen" & neuer Speiseeintrag wird in Datenbank angelegt & Ja \\\hline
\hline 6 & Kategorie hinzufügen & Admin gibt neue Kategoriebezeichnung ins Formular ein und klickt auf "Kategorie hinzufügen” & neue Kategorie wird in Datenbank angelegt & Ja \\\hline
\hline 7 & Speiseeintrag löschen & Admin wählt Speiseeintrag aus und klickt auf "Speiseeintrag Löschen"-Button & ausgewählter Speiseeintrag wird gelöscht & Ja \\\hline
\hline 8 & Kategorie löschen & Admin wählt Kategorie aus und klickt auf "Kategorie Löschen"-Button & ausgewählte Kategorie wird gelöscht & Ja \\\hline
\hline 9 & Tischroute verändern & Admin wählt Tischnummer aus und gibt Tischroute ins Formularfeld ein & Tischroute des Tisches wird geändert & Ja \\\hline
\end{tabular}
