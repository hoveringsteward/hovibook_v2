...
\section{Allgemeine technische Planung}
  ...
  \subsection{Allgemeiner Code-Aufbau}
...
$this->render('DATEIBEZEICHNUNG.html.twig')
	...
	ANMERKEN WESHALB DAS TROTZ KOMMENTAR VERWENDET WIRD
	\lstset{language=php}
  	\begin{lstlisting}
/**
...
>>>>>>> 66bbda0b9207d935e457f555b342e159781c49e8
...
*/
	...
	\lstset{language=php}
  	\begin{lstlisting}
/**
* @ORM\Column(type="string", length=LAENGE)
*/
  	\end{lstlisting}
