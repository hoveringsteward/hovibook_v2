...
\textbf{Screens der digitalen Speisekarte}
			\begin{figure}[H]
			\begin{centering}
			\fbox{ \includegraphics[width = 0.47\textwidth]{Bilder/Jok_login} }
			\fbox{ \includegraphics[width = 0.47\textwidth]{Bilder/Jok_tnr} }
			\par\end{centering}
			...
			\begin{figure}[H]
			\begin{centering}
			\fbox{ \includegraphics[width = 0.47\textwidth]{Bilder/Jok_speisekarte} }
			\fbox{ \includegraphics[width = 0.47\textwidth]{Bilder/Jok_status} }
			\par\end{centering}
