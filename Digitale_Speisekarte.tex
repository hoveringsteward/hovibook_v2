...
\textbf{Screens der digitalen Speisekarte}
			\begin{figure}[H]
			\begin{centering}
			\includegraphics[width = 0.6\textwidth]{Bilder/Jok_login.png}
			\includegraphics[width = 0.6\textwidth]{Bilder/Jok_tnr.png}
			\par\end{centering}
			...
			\begin{figure}[H]
			\begin{centering}
			\includegraphics[width = 0.6\textwidth]{Bilder/Jok_speisekarte.png}
			\includegraphics[width = 0.6\textwidth]{Bilder/Jok_status.png}
			\par\end{centering}
