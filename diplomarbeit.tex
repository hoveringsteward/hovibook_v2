...
Martin Mair, Projektmanagement Lehrer der HTL Rennweg hat das Team motiviert und durch Übermittlung seiner Erfahrungen unterstützt. Durch seine Hilfe war es uns möglich, von Salzburg aus am Accenture Finale teilzunehmen.

Peter Oppeker und Ruth Korper haben uns bei rechtlichen und finanziellen Fragen beraten.


Nicht zuletzt möchten wir unseren Dank unseren Partnern und Sponsoren, ganz besonders der \textbf{GRZ IT Center GmbH}
ausdrücken, da wir die Diplomarbeit ohne ihre Unterstützung nicht in diesem Rahmen umsetzen hätten können.

Durch Gabriele Ettenberger vom \textbf{OFI}, wurden alle 2-4 Wochen Coachings abgehalten, die einerseits mit Teambuilding und Gruppendynamik, andererseits mit Projektmanagement und Gamestorming gefüllt waren.
...
Durch \textbf{LivingPhotos by Michael Pyerin} wurden Team- und Portraitfotos gemacht, die das Team für Marketingzwecke auf Sozialen Medien und dem Blog genützt hat.
...
Danke an das Space Team der TU Wien, das uns in der Planungsphase mit Wissen über Positionierungssystemen geholfen hat.
