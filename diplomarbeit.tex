...
Tina Lentschik von \textbf{WebBoost} hat uns Tipps und Tricks zu \cite{SEO} verraten, dadurch konnte unser Blog optimiert werden. 

Durch \textbf{LivingPhotos by Michael Pyerin} wurden Team- und Portraitfotos aufgenommen, die das Team für Marketingzwecke auf Sozialen Medien und dem Blog genützt hat.


Folgende Personen haben uns während der Diplomarbeit unterstützt, ein großes Dankeschön!

Lars Paasche von der TU Berlin hat bei der Ideeentwicklung geholfen. Durch sein Wissen konnte er technische Fragen beantwortet und bei Problemen helfen.
...
Auch John Kulha, Schüler der HTL Rennweg, ist uns bei technischen Fragen rund um Java zur Seite gestanden.

Danke an das Space Team der TU Wien, das uns in der Planungsphase mit Wissen über Positionierungssysteme geholfen hat.

Danke an Roman Marchel, Deutschtrainer und freier Schriftsteller, hat uns bei der Korrektur des Diplomarbeitsbuchs unterstützt.
