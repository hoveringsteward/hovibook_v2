...
\textbf{\large{}Hovering Steward}\\
 \vspace{15mm}
 ausgeführt an den\\
 Höheren Abteilungen für Mechatronik/Automatisierung \& Informationstechnologie/Medientechnik\\
...
Um die Ziele des Projekts zu erreichen, wurde eine umfangreiche Recherche durchgeführt. Zu Beginn wurde nach bereits existierenden, ähnlichen Projekten gesucht, um weiters
...
Alle Vorteile und Hindernisse in Betracht gezogen, lässt sich sagen, dass das Projekt aus einer Vielzahl verschiedener Komponenten besteht, dessen perfekte Zusammenarbeit Voraussetzung
...
Sämtliche allgemeine Personenbezeichnungen gelten gleichwohl für beiderlei Geschlecht.
...
DI Martin Mair, Projektmanagement Lehrer der HTL Rennweg, hat das Team motiviert und durch Übermittlung seiner Erfahrungen unterstützt. Durch seine Hilfe war es uns möglich, von Salzburg aus am Accenture Finale teilzunehmen.

Mag. Peter Oppeker und Mag. Ruth Korper haben uns bei rechtlichen und finanziellen Fragen beraten.


Ein riesengroßes Dankeschön gilt auch unseren Partnern und Sponsoren, ganz besonders unserem Hauptsponsor \textbf{GRZ IT Center GmbH}, da wir die Diplomarbeit ohne ihre Unterstützung nicht in diesem Rahmen umsetzen hätten können.

Durch Gabriele Ettenberger vom \textbf{OFI}, wurden alle 2 bis 4 Wochen Coachings abgehalten, die einerseits mit Teambuilding und Gruppendynamik, andererseits mit Projektmanagement und Gamestorming gefüllt waren, ebenso wurden wir von der Firma finanziell unterstützt.

Die \textbf{EVO-tech GmbH} hat uns Druckmaterial für den 3D-Druck zur Verfügung gestellt.

Ein großes Dankeschön auch an den Verein Practical Robotics Institute Austria (\textbf{PRIA}), der uns mit Wissen unterstützt hat und uns zu einer Präsentation unseres Projektes bei der 2016 European Conference on Educational Robotics (ECER) eingeladen hat.

Durch Natalia Zmajkovicova von der \textbf{twyn group} haben wir die Marketingwelt besser kennengelernt.

Tina Lentschik von \textbf{WebBoost} hat uns Tipps und Tricks zu SEO verraten, dadurch konnte unser Blog optimiert werden.

Durch \textbf{LivingPhotos by Michael Pyerin} wurden Team- und Portraitfotos aufgenommen, die das Team für Marketingzwecke in sozialen Medien und dem Blog genützt hat.


Folgende Personen haben uns während der Diplomarbeit unterstützt, ein großes Dankeschön!

Lars Paasche von der TU Berlin hat bei der Ideeentwicklung geholfen. Durch sein Wissen konnte er technische Fragen beantworten und bei Problemen helfen.

Martin Zimmermann, Schüler der HTL Rennweg, hat uns bei Fragen bezüglich Multicoptern weitergeholfen.

Manuel Zika, Absolvent der HTL Rennweg hat uns netzwerktechnische Fragen beantwortet.

Felix Lucny, Absolvent der HTL Rennweg, hat bei Problemen mit Frameworks geholfen.

John Kulha, Schüler der HTL Rennweg, ist uns bei technischen Fragen rund um Java zur Seite gestanden.

Danke an das Space Team der TU Wien, das uns in der Planungsphase mit Wissen über Positionierungssysteme geholfen hat.

Danke an Roman Marchel, Deutschtrainer und freier Schriftsteller, der uns bei der Korrektur des Diplomarbeitsbuchs unterstützt hat.

Durch Wolfram Bornberg wurden die Grundlagen von Mikrocontrollern erlernt.

Isabella Bornberg und Josefine Dovits haben bei englischen Texten an mögliche Partner und Sponsoren geholfen.

Zu guter Letzt ein riesengroßes Dankeschön an Samantha Fuchs! Ohne sie wäre die Projektidee nie entstanden.
...
\include{Digitale_Speisekarte}

\include{Positionierung}

\include{Elektronik}

\include{Sensoren_Aktoren}

\include{Firmware}

\include{Kommunikation_Applikation_und_Hexacopter}
