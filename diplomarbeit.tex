...
soll eine digitale Speisekarte das automatische System vervollständigen. Optional wird ein Event organisiert um das System in der Praxis zu testen.
...
diese zu analysieren und eine Übersicht über den Stand der verwendeten Technoliegien zu bekommen. Im folgenden Schritt wurde ein Konzept für jede, für dieses Projekt
gewählte Technologie erstellt. Zuletzt wurde jedes erarbeitete Konzept getestet, um seine Funktionalität sicherzustellen.
...
für ein funktionierendes System ist.
...
Additionally a digital menu should complete the automatic system. As an optional goal an event to test and apply the system will be organized.
...
together perfectly to make the system work properly.
