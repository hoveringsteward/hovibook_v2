...
\section{Allgemeine technische Planung}
  ...
  \subsection{Positionierungssystem}
    ...
    Verfahren zur Positionsbestimmung \cite{pos_signal_2} \cite{pos_signal_4}
    ...
    \paragraph{GPS (Global Positioning System)}\\
    ...
    \paragraph{RFID (radio-frequency identification)}\\
    ...
    \paragraph{WPS (WLAN Positioning System)}\\    
    ...
    \paragraph{Pixelorienterte Segmentierung} \cite{Seg_punkt}
    ...
    \paragraph{Modellbasierte Segmentierung} \cite{Seg_modell}
    ...
    \paragraph{Regionenorientierte Segmentierung} \cite{Seg_region}
    ...
    \paragraph{Texturorientierte Segmentierung} \cite{Seg_textur}
    ...
    \textbf{Kanten- und Eckenorientierte Segmentierung}\\
    ...
    \paragraph{Klassifikation} \cite{Bildverarbeitung}
...
\section{Navigation}
  ...
  \subsection{Umsetzung}
    ...
    \paragraph{Überprüfen von Aileron}
    ...
    \paragraph{Überprüfen von Elevator}\\
    ...
    \paragraph{Überprüfen von Rudder}\\
