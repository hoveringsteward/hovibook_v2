...
Für die Kommunikation zwischen dem Hexacopter und dem Server wurden folgende Grundlagen festgelegt:
...
Damit das Programm mit JDBC arbeiten kann muss man es zuerst von Oracle downloaden und anschließend mit einem Rechtsklick auf das Javaprojekt unter dem Menüpunkt "Properties" als Bibliothek angeben.
...
Um zu überprüfen, ob der Hexacopter in der Basis ist und somit bereit dazu, eine Speise auszuliefern, wartet der Server darauf, dass eine bestimmte Nachricht geschickt wird. Sobald diese bestimmte Nachricht ankommt, liefert die Funktion "true" zurück.
